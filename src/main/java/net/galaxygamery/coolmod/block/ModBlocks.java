package net.galaxygamery.coolmod.block;

import net.fabricmc.fabric.api.item.v1.FabricItemSettings;
import net.fabricmc.fabric.api.object.builder.v1.block.FabricBlockSettings;
import net.galaxygamery.coolmod.CoolMod;
import net.galaxygamery.coolmod.block.custom.SoundBlock;
...
public class ModBlocks {
    ...
    public static final Block RUBY_SLAB = registerBlock("slab_block",
    ...
    public static void registerModBlocks() {
        CoolMod.LOGGER.info("Registering ModBlocks for "+CoolMod.MOD_ID);
    }
}
